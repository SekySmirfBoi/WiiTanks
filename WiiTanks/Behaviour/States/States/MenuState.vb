Public Class MenuState
    ...
    Public Overrides Sub Create()
        ...
        _uiManager.AddComponent(New TextBlock(New Point(100, 100), "dick", SharedResources.BlankImage))
        _uiManager.AddComponent(New Button(New Point(SharedResources.CentreWindowCoord.X - 40, 100), "ilugylku", New Size(80, 40),
                                           Function() As Boolean
                                               MsgBox("fuck you")
                                           End Function))
    End Sub
